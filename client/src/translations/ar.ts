export const ar = {
  ...
  'landing.subtitle': 'بسّط تفسير الوثائق القانونية مع رؤى ذكية وأدوات سهلة الاستخدام',
  'landing.description': 'ارفع عقودك واحصل على تحليل فوري وتقييم المخاطر وملخصات بلغة بسيطة مدعومة بتكنولوجيا الذكاء الاصطناعي المتقدمة.',
