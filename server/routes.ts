    ...
    try {
      ...
      const supportEmailHtml = `
        ...
        <html>
          <head>
            <meta charset="utf-8">
            <title>New Support Request - Contract Clarity</title>
            <style>
              body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; }
              .header { background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%); color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px; }
              ...
              .issue-content { background: white; padding: 15px; border-radius: 6px; border-left: 4px solid #6366f1; margin-top: 10px; }
          ...
          <body>
            <div class="header">
              ...
              <p style="margin: 5px 0 0 0; opacity: 0.9;">Contract Clarity Support System</p>
            </div>
            ...
            <div class="footer">
              <p>This support request was submitted through the Contract Clarity website.</p>
      ...
      const supportEmailText = `
        NEW SUPPORT REQUEST - Contract Clarity
      ...
      try {
        await emailService.sendEmail({
          ...
          from: `Contract Clarity Support <noreply@contractclarity.co.uk>`,
          subject: `New Support Request from ${name} - Contract Clarity`,
          text: supportEmailText,
          html: supportEmailHtml
        });
        
        console.log('✅ Support notification email sent to info@contractclarity.co.uk');
      } catch (emailError) {
      ...
      try {
        const confirmationEmailHtml = `
          ...
          <html>
            <head>
              <meta charset="utf-8">
              <title>Support Request Received - Contract Clarity</title>
              <style>
                body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; }
                .header { background: linear-gradient(135deg, #6366f1 0%, #8b5cf6 100%); color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px; text-align: center; }
                .content { background: #f8fafc; padding: 20px; border-radius: 8px; margin-bottom: 20px; }
                .highlight { background: white; padding: 15px; border-radius: 6px; border-left: 4px solid #10b981; margin: 20px 0; }
                .footer { font-size: 12px; color: #6b7280; text-align: center; margin-top: 30px; }
              </style>
            </head>
            <body>
              <div class="header">
                ...
                <p style="margin: 5px 0 0 0; opacity: 0.9;">Contract Clarity</p>
              </div>
              
              <div class="content">
                <p>Hi ${name},</p>
                
                <p>Thank you for contacting Contract Clarity support. We have received your support request and our team will review it promptly.</p>
                ...
                <p>If you have any urgent issues or additional questions, please don't hesitate to reach out to us again.</p>
                
                <p>Best regards,<br>
                The Contract Clarity Support Team</p>
              </div>
              
              <div class="footer">
                <p>Contract Clarity | support@contractclarity.co.uk</p>
        ...
        await emailService.sendEmail({
          to: email,
          from: `Contract Clarity Support <info@contractclarity.co.uk>`,
          subject: 'Support Request Received - Contract Clarity',
          text: `Hi ${name},\n\nThank you for contacting Contract Clarity support. We have received your support request and our team will review it promptly.\n\nYou'll receive a response within 24 hours at this email address.\n\nBest regards,\nThe Contract Clarity Support Team`,
      ...
      res.status(200).json({ 
        message: "Support request submitted successfully! You'll receive a confirmation email shortly.",
        timestamp: new Date().toISOString()
      });
    } catch (error) {
